...
class MatchTestCase(TestCase):
    ...
    def test_get_match_existing(self, mock_get):
        ...
        self.assertEqual(match[0]["match_id"], self.match_id)
        self.assertEqual(match[0]["tournament_id"], self.tournament_id)
        self.assertEqual(match[0]["player1"], self.player1_id)
        self.assertEqual(match[0]["player2"], self.player2_id)
        self.assertEqual(match[0]["player1_score"], 11)
        self.assertEqual(match[0]["player2_score"], 8)
        self.assertEqual(match[0]["round"], 1)
        self.assertTrue(match[0]["is_active"])
